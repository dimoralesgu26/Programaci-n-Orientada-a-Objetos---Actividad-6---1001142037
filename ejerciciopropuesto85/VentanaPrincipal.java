...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        try {
               String númeroHabitación = JOptionPane.showInputDialog(null,"Ingrese número de habitación","Salida de huéspedes",JOptionPane.QUESTION_MESSAGE);
        ...
        if (hotel.buscarHabitaciónOcupada(número)) {
